...
const News = () => {
  return (
    <Container>
      <Typography
        variant="h4"
        sx={{ my: 3, textAlign: "center", fontWeight: 500 }}
      >
        MotoGP Blogs{" "}
      </Typography>
          ...
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardContent sx={{ height: "155px" }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Already the hottest electric super naked, the new RS version of
                the Eva Ribelle delivers acceleration and spec no other electric
                naked can match – at a price.
              </Typography>
            </CardContent>
            <CardActions>
              <Button
        ...
        <Grid item xs={12} md={4} className="news-design">
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardContent sx={{ height: "155px" }}>
              ...
              <Typography variant="body2" color="text.secondary">
                R1-based roadster is not just probably the best of the Japanese
                ‘super nakeds’ – it’s right up there with the best of the
                Europeans, too!
              </Typography>
            </CardContent>
            <CardActions>
          ...
          <Card sx={{ maxWidth: 345 }}>
            ...
            <CardContent sx={{ height: "155px" }}>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                restyle, Euro5 update and improved spec for 2021 – yet is still
                a bargain price.
              </Typography>
            </CardContent>
            <CardActions>
